...
const quest =  [
 'Q2: What is output? <code class="text-light"><br /> let a = {} <br /> let b = {} <br /> console.log(a === b)</code>',
 'Q3: How to generate random no. between a and b using Javascript?',
 'Q4: What is output? <br /> <code class="text-light">let obj = { <br /> add: function(){<br /> console.log(5 + 7 + "5")} <br />} <br /> obj.add</code> ',
 'Q5: What is output? <br /> <code class="text-light">let str = ["1", "2", "3", "4", "5"] <br /> str.splice(2, 2, "6") <br /> console.log(str)</code>',
 'Q6: What is output? <br /> <code class="text-light"> let a = "Global" <br /> if(true){<br /> a = "Local" } <br /> console.log(a)</code>',
 'Q7: Who invented Javascript?',
 'Q8: Which of the following is not javascript function?',
 'Q9: Which of the following is not javascript keyword?',
 'Q10: What is output? <br /> <code class="text-light">console.log(Number("10") + 100 + "20")</code>'
]
let total = 10;
let scoreCount = 0
let count = 0
